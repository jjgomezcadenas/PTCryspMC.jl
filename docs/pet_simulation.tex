...
(\texttt{Solid}: \texttt{Cylinder}, and the coming \texttt{CylShell}), logical volumes
...
photoelectric and pair cross sections at an energy. Material tables are needed for water
or soft tissue (the phantom) and the crystal materials (CsI, LYSO, BGO).
