...
energy, and at what time. The same engine drives both application modes (Clinical: a radiotracer
distribution at a known activity; Proton Activity: the activation a proton dose leaves behind),
which are described in the companion document \texttt{PTCryspMC\_app}.
\end{abstract}
