...
section~\ref{sec:deliverables} was measured in the earlier off-centre frame. The v2 convention is
\textbf{tumour} centring (this section); the reference detector's three-scenario master
(Fig.~\ref{fig:shard}) is the first v2 production, and the survey is being re-run in this convention
for the final $\sigma_R$ comparison.
