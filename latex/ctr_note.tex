...
the containment at the pinned windows. (These validation shards were run with the earlier
$3X_0$ depths; the $2X_0$ standard slightly \emph{narrows} the DOI contribution to
$\Delta t_{\mathrm{raw}}$, so the windows quoted are marginally conservative. The study is
re-run with the production geometry before each production.)
